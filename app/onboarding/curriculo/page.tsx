...
export default function CurriculoBuilder() {
  ...
  const handleGenerateResume = async () => {
    ...
    try {
      ...
      // Depois de gerar, podes mandar para /onboarding/checkout ou /curriculo
  ...
  const handleGenerateLetter = async () => {
    ...
    await generate(token, {
      ...
      description:
        "Carta gerada automaticamente com base no seu perfil profissional.",
    });
  };
  ...
  const isStep1Complete =
    resumeData.fullName && resumeData.email && resumeData.phone;
...
useEffect(() => {
      ...
      <div className="max-w-7xl mx-auto p-4 md:p-10">
        ...
        <div className="mb-10 text-center lg:text-left">
          ...
          <p className="text-muted-foreground mt-2 text-lg">
            Pronto para ser distribuído nos maiores portais de emprego de
            Portugal.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7">
                  ...
                  <div className="flex flex-col items-center sm:flex-row gap-6 p-4 bg-slate-50 dark:bg-slate-900 rounded-xl border-2 border-dashed border-slate-200">
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Recomendado: Quadrada, JPG ou PNG. Máx 2MB.
                      </p>
                      <input
                        type="file"
                        ref={fileInputRef}
              ...
              <Card className="border-none shadow-xl">
                ...
                <CardContent className="space-y-6">
                  {resumeData.experiences.map((exp) => (
                    <div
                      key={exp.id}
                      className="p-4 border rounded-xl space-y-4 bg-white dark:bg-slate-900 shadow-sm relative"
                    >
                      <Button
                        variant="ghost"
                        size="icon"
              ...
              <Card className="border-none shadow-xl">
                ...
                <CardContent className="space-y-6">
                  {resumeData.education.map((edu) => (
                    <div
                      key={edu.id}
                      className="p-4 border rounded-xl space-y-4 bg-white dark:bg-slate-900 relative"
                    >
                      <Button
                        variant="ghost"
                        size="icon"
                      ...
                      <Input
                        ...
                        onChange={(e) => {
                          const updated = resumeData.education.map((x) =>
                            x.id === edu.id
                              ? { ...x, graduationYear: e.target.value }
                              : x
                          );
                          setResumeData({
                            ...resumeData,
            ...
            {step === 4 && (
              <Card className="border-none shadow-xl">
                <CardHeader>
                  <CardTitle>Competências e Finalização</CardTitle>
                </CardHeader>
                <CardContent className="space-y-6">
                  ...
                  <div className="flex flex-col gap-4 pt-6 border-t mt-6">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      >
                        {loadingLetter
                          ? "A gerar carta de apresentação..."
                          : "Gerar Carta de Apresentação"}
                      </Button>

                      {!isPremium && (
                        <p className="text-xs text-red-500">
                          O download do currículo em PDF será liberado após a
                          conclusão do pagamento no checkout.
                        </p>
                      )}
                    </div>
                  </div>
            ...
            <div className="sticky top-10">
              ...
              <div className="bg-white dark:bg-slate-900 rounded-xl shadow-2xl overflow-hidden min-h-[700px] border border-slate-200">
                ...
                <div className="bg-slate-900 p-8 text-white flex gap-6 items-center">
                  ...
                  <div>
                    ...
                    <p className="text-blue-400 font-medium">
                      {resumeData.experiences[0]?.position || "Cargo Pretendido"}
                    </p>
                ...
                <div className="p-8 space-y-6">
                  ...
                  {resumeData.summary && (
                    <section>
                      <h4 className="text-xs font-bold text-slate-400 uppercase tracking-widest border-b pb-1 mb-2">
                        Resumo
                      </h4>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {resumeData.skills.map((skill) => (
                          <Badge
                            key={skill}
                            variant="secondary"
                            className="bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-normal"
                          >
                            {skill}
                          </Badge>
                        ))}
                  ...
                  {/* Carta de Apresentação (preview simples, se quiseres) */}
                  {letter && (
                    <section>
                      <h4 className="text-xs font-bold text-slate-400 uppercase tracking-widest border-b pb-1 mb-3">
  ...
  {isPremium ? (
    ...
    <>
      <Button
        disabled
        className="bg-gray-300 text-gray-600 cursor-not-allowed h-12"
      >
